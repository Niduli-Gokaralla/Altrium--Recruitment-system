...
@Entity
@Table(name = "interview_feedback", uniqueConstraints = {
        @UniqueConstraint(name = "uq_interview_role", columnNames = {"interview_id", "evaluator_role"})
})
public class InterviewFeedback {
    ...
    // HR, HIRING_MANAGER, or INTERVIEWER — each role gets its own row per
    // interview, so their evaluations never overwrite each other.
    @Column(name = "evaluator_role", nullable = false)
