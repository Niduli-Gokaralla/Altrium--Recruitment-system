...
public class JobOpening {
    ...
    // AC: automated CV screening — a candidate's computed match score
    // (percentage of required skills found in their CV) is compared
    // against this cutoff to produce a Shortlist/Reject recommendation.
    @Column(name = "cutoff_score", nullable = false)
    private Integer cutoffScore = 60;
    ...
    public void setCutoffScore(Integer cutoffScore) { this.cutoffScore = cutoffScore; }
